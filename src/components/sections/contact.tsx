...
import { insertContactSubmissionSchema, type InsertContactSubmission } from "@/types/schema";
...
export default function Contact() {
  ...
  const onSubmit = async (data: InsertContactSubmission) => {
    ...
    try {
      ...
      const mailtoLink = `mailto:sddgmes@gmail.com?subject=${subject}&body=${body}`;
      ...
      toast({
        title: "Error",
        description: "Failed to open email client. Please email sddgmes@gmail.com directly.",
        variant: "destructive",
      });
    } finally {
                          ...
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              ...
                              <SelectContent>
                                ...
                                <SelectItem value="design">Circuit Design</SelectItem>
                                <SelectItem value="analysis">System Analysis</SelectItem>
