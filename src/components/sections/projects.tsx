    ...
    <section id="projects" className="py-20 bg-card/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-secondary-foreground max-w-3xl mx-auto" data-testid="text-projects-description">Sharing case studies and scenarios showing when a Professional Electronics Engineer services are essential for project success.</p>
        </motion.div>
