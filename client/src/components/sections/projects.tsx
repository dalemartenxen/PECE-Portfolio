        ...
        >
          <div className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-border max-w-2xl mx-auto">
            ...
            <p className="text-secondary-foreground mb-8">
              Discover detailed case studies, real-world scenarios, and practical examples of when PECE services are required for compliance, safety, and regulatory approval.
            </p>
